import { ReactNode, CSSProperties, ClipboardEvent, InputHTMLAttributes, MutableRefObject } from 'react';
...
export interface InputProps
  extends Omit<
    ...
    'onChange' | 'prefix' | 'className' | 'size' | 'height' | 'maxLength' | 'onFocus' | 'onBlur'
  > {
  style?: CSSProperties;
