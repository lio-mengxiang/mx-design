...
export interface TableProps<T = any> {
  ...
  /**
   * @zh 表格列冻结设置，rightFixedColumnsLength代表右边冻结几列, 如果是多行表头，以第一行为准
   * @en setting of fix column， rightFixedColumnsLength represents the frozen columns on the right. if there are multi-line header, first row shall prevail
   * @default 0
   */
   ...
   * @defaultValue true
   */
  border?: { wrapper?: boolean; headerCell?: boolean; bodyCell?: boolean; cell?: boolean };
  /**
