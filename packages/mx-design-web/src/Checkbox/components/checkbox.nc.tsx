...
function NcCheckbox<T extends string | number>(baseProps: CheckboxProps<T>, ref) {
...
const ForwardRefCheckRef = React.forwardRef(NcCheckbox);
...
export { CheckboxComponent as NcCheckbox };
